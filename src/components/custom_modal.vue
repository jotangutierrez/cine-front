    ...
    <modal name="hello-world" height="auto" :scrollable="true" @before-open="beforeOpen">
      <div class="p-5 h-full">
        ...
        <form class=" md:flex md:flex-wrap md:justify-between" action="/v1/reservations" method="post"
          ...
          <div class="flex flex-col mb-4 px-4 md:w-1/2">
            <label class="block font-montserrat text-gray-700 text-sm font-bold mb-2" for="name">Nombre completo</label>
            <t-input v-model="film.name" name="name"></t-input>
          </div>

          <div class="flex flex-col mb-4 px-4 md:w-1/2">
            <label class="block font-montserrat text-gray-700 text-sm font-bold mb-2" for="username">Celular</label>
            <t-input v-model="film.document_number" name="document_number"></t-input>
          </div>

          <div class="flex flex-col mb-4 px-4 md:w-1/2">
            <label class="block font-montserrat text-gray-700 text-sm font-bold mb-2" for="username">Cédula</label>
            <t-input v-model="film.phone" name="document_number"></t-input>
          </div>

          <div class="flex flex-col mb-4 px-4 md:w-1/2">
            <label class="block font-montserrat text-gray-700 text-sm font-bold mb-2" for="username">Correo electrónico</label>
